...
func (r *HistoryResource) GetRevisions(context *restful.Context) { _ = "STUB: not implemented"; return }
...
func (r *HistoryResource) URLPatterns() []restful.Route { _ = "STUB: not implemented"; return nil }
